...
# )
# def test_create_ssl_mask_for_random_type(
#     mask_type, center_fractions, accelerations, expected_mask_func, x, seed, half_scan_percentage
# ):
#     """
#     Test that the function returns random 1D masks and loss masks for SSDU.
#
#     Args:
...
#         None
#     """
#     _x = create_input([x[0], x[1], x[2], 15, 2])
#
...
#         raise AssertionError
#
#     input_data = torch.view_as_complex(_x).numpy()
#     input_mask = np.repeat(mask, input_data.shape[1], axis=1)
#
#     ssl_masker = SSDUMasker()
#     mask, loss_mask, _ = ssl_masker(input_data=input_data[0], input_mask=input_mask)
#
#     if np.allclose(mask, input_mask):
#         raise AssertionError
#     if np.allclose(loss_mask, input_mask):
#         raise AssertionError
#     if mask.shape != input_mask.shape:
#         raise AssertionError
#     if loss_mask.shape != input_mask.shape:
#         raise AssertionError
#
#
# @pytest.mark.parametrize(
...
# )
# def test_create_ssl_mask_for_equispaced1d_type(
#     mask_type, center_fractions, accelerations, expected_mask_func, x, seed, half_scan_percentage
# ):
#     """
#     Test that the function returns equispaced 1D masks and loss masks for SSDU.
#
#     Args:
#         mask_type: The type of mask to be created
#         center_fractions: The center fractions of the mask
...
# )
# def test_create_ssl_mask_for_equispaced2d_type(
#     mask_type, center_fractions, accelerations, expected_mask_func, x, seed, half_scan_percentage
# ):
#     """
#     Test that the function returns equispaced 2D masks and loss masks for SSDU.
#
#     Args:
#         mask_type: The type of mask to be created
#         center_fractions: The center fractions of the mask
...
# )
# def test_create_ssl_mask_for_gaussian1d_type(
#     mask_type, center_fractions, accelerations, expected_mask_func, x, seed, half_scan_percentage, scale
# ):
#     """
#     Test that the function returns gaussian 1D masks and loss masks for SSDU.
#
#     Args:
#         mask_type: The type of mask to be created
#         center_fractions: The center fractions of the mask
...
# )
# def test_create_ssl_mask_for_gaussian2d_type(
#     mask_type, center_fractions, accelerations, expected_mask_func, x, seed, half_scan_percentage, scale
# ):
#     """
#     Test that the function returns gaussian 2D masks and loss masks for SSDU.
#
#     Args:
#         mask_type: The type of mask to be created
#         center_fractions: The center fractions of the mask
...
# )
# def test_create_ssl_mask_for_poisson2d_type(
#     mask_type, center_fractions, accelerations, expected_mask_func, x, seed, half_scan_percentage, scale
# ):
#     """
#     Test that the function returns poisson 2D masks and loss masks for SSDU.
#
#     Args:
#         mask_type: The type of mask to be created
#         center_fractions: The center fractions of the mask
