    ...
    def __getitem__(self, i: int):
        ...
        with h5py.File(fname, "r") as hf:
            ...
            if "mask" in hf:
                ...
                if "loss_mask" in hf:
                    loss_mask = np.asarray(self.get_consecutive_slices(hf, "loss_mask", dataslice))
                    if loss_mask.ndim == 3:
                        loss_mask = loss_mask[dataslice]

                mask = np.stack([mask.byte(), loss_mask.byte()], axis=0)
